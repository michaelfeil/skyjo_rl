...
def test_timing():
    ...
    time_2500_games = timeit.timeit('sample_run(games=2500, verbose=0, config={"num_players": 3})', 
                                    number=1, globals={"sample_run": sample_run})
    print(time_2500_games)
    assert time_2500_games < 180, f"took longer then 180 seconds ({time_2500_games}) to process 2500 games. common is around 20s"
